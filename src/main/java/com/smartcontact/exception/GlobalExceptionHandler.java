...
public class GlobalExceptionHandler {
    ...
    public String handleTypeMismatch(
            MethodArgumentTypeMismatchException ex, RedirectAttributes ra, HttpServletRequest request) {
        ...
        if (parameterName.equals("currentPage")) {
            ...
            ra.addFlashAttribute("type", "error");
            String uri = request.getRequestURI();
            return "redirect:" + uri + "?currentPage=0";
        }
    ...
    public String maxAttempt(MaxAttemptsException ex, RedirectAttributes ra) {
    ...
    public String handle500(RuntimeException ex, RedirectAttributes ra) {

        ra.addFlashAttribute("msg", "Internal Server Error!");
        ra.addFlashAttribute("type", "error");
